...
export default function PaymentRefunded() {
  ...
  useEffect(() => {
    async function fetchPaymentDetails() {
      if (!paymentId) {
        setError('Refund information not found');
        setLoading(false);
        return;
      }
      ...
      try {
        ...
        if (result.success) {
          ...
          setError('Could not verify refund status');
        }
      } catch (error) {
    ...
    <div className="max-w-2xl p-6 mx-auto my-8 bg-white shadow-md rounded-xl">
      {loading ? (
        ...
        <div className="p-5 space-y-4 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Refund Verification Issue</h2>
        ...
        <div className="p-5 space-y-6 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Refund Processed Successfully!</h2>
          <p className="text-gray-600">Your payment has been refunded and should be reflected in your account shortly.</p>
          
          <div className="p-4 text-left border border-gray-200 rounded-lg bg-gray-50">
            <div className="mb-3 text-lg font-medium text-gray-800">Refund Details</div>
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div className="text-gray-600">Refund Date:</div>
              <div className="font-medium text-gray-800">{formatDate(payment.updatedAt)}</div>
              
              <div className="text-gray-600">Status:</div>
              <div className="font-medium text-green-600">Refunded</div>
            </div>
          </div>
