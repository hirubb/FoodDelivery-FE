          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            {isPendingOrder && (
              <button
                ...
                className={`flex-1 py-2 ${isPlacingOrder ? "bg-gray-400" : "bg-[#FC8A06] hover:bg-[#E67E22]"
            ...
            <button
              className={`bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 transition ${cancelLoading ? "opacity-75 cursor-not-allowed" : ""
                }`}
