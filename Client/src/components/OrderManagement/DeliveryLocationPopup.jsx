      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-hidden">
        ...
        <div className="p-4 border-b">
          <button
            ...
            className="flex items-center justify-center w-full p-3 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 transition-colors"
          >
            {isLoading ? (
              <div className="animate-spin h-5 w-5 border-2 border-[#FC8A06] border-t-transparent rounded-full mr-2"></div>
            ) : (
              <Crosshair size={20} className="text-[#FC8A06] mr-2" />
            )}
